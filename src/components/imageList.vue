<template>
  ...
  <div class="tab-box">
      ...
      <el-button type="pain" size="small"  @click="dialogUp = true" v-if="isShow">上传素材</el-button>
  </div>
  ...
  <div>
    <el-row :gutter="20" style="margin-top: 20px">
      <el-col :xs="12" :sm="6"  :lg="4"   v-for="(image,index) in images"
        ...
        <div class="checkBox" v-show="selected == index">
          <i class="el-icon-check" style="font-size:30px;color:#333"></i>
        </div>
